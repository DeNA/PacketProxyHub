...
const TabPfConfView : React.FC<Props> = ({config}) => {
...
load anchor "com.apple" from "/etc/pf.anchors/com.apple"`
    ...
    const handleOnChange = (editor: any, data: any, value: any) => {
        dispatch(configUpdate({id: config.id, changes: {...config, pfConf:value}}))
    }
    ...
    return (
        <div style={{width:"90%",margin:"0 auto",marginTop:"2em"}}>
            ...
            <div style={{margin:"1em 0"}}>
                <Code
                    value={config.pfConf.length > 0 ? config.pfConf : template }
                    mode='shell'
